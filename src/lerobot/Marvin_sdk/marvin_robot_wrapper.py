...
class MarvinRobotWrapper:
    ...
    def __init__(self, robot_ip='192.168.15.190', control_mode='position'):
        """初始化
...
def test_marvin_robot():
    ...
    robot = MarvinRobotWrapper(robot_ip='192.168.1.190', control_mode=control_mode)
    ...
    try:
        ...
        # 4. 移动：两臂最后一个关节转15度，夹爪开到11.46度（约0.2弧度）
        print("步骤 4: 移动关节...")
