...
robot.set_impedance_type(arm='B',type=3) #type = 1 关节阻抗;type = 2 坐标阻抗;type = 3 力控
robot.send_cmd()
time.sleep(0.5)
...
robot.clear_set()
# 设置是在Y轴方向有5厘米的调节范围
robot.set_force_control_params(arm='B',fcType=0, fxDirection=[0, 3, 0, 0, 0, 0], fcCtrlpara=[0, 0, 0, 0, 0, 0, 0],
                                        fcAdjLmt=5.)
time.sleep(0.5)
...
robot.set_force_cmd(arm='B',f=10)
time.sleep(0.5)
