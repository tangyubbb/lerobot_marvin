...
def init_keyboard_listener():
    ...
    events["align_before_next"] = False  # Right arrow: align then continue to next episode
    events["align_before_reset"] = False  # Left arrow: align then reset
    ...
    def on_press(key):
        try:
            if key == keyboard.Key.right:
                events["align_before_next"] = True
                events["exit_early"] = True
                logging.info("Right arrow: align then end episode")
            elif key == keyboard.Key.left:
                events["align_before_reset"] = True
                events["rerecord_episode"] = True
                events["exit_early"] = True
                logging.info("Left arrow: align then re-record episode")
            elif key == keyboard.Key.esc:
                events["stop_recording"] = True
                events["exit_early"] = True
                logging.info("Escape: stopping recording")
